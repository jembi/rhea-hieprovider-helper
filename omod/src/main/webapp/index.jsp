...
<openmrs:require privilege="View Providers" otherwise="/login.htm" redirect="${pageContext.request.contextPath}/admin/provider/index.htm" />
...
<h2><spring:message code="Provider.title"/> Overidden</h2>
